        ...
        <header>
            ...
            <div className="bottom-bar row row-cols-2">
                <div className="col wallet p-0">
                    <div
                        onClick={() => changeTab("/account?wallet")}
                        className={`${pathname === "?wallet" ? "text-dark-coral denim" : "dark-coral text-dark-blue"} mt-1 me-1 mb-1 py-2 px-3`}
                    >
                        <img
                            src={pathname !== "?wallet" ? "/files/5_1_blue.png" : "/files/5_1_off.png"}
                            height={15}
                ...
                <div className="col rating-table p-0">
                    <div
                        onClick={() => changeTab("/account?rating")}
                ...
                <div className="col challange p-0">
                    <div
                        onClick={() => changeTab("/account?challange")}
                ...
                <div className="col feedo p-0">
                    <div
                        onClick={() => changeTab("/account?feedo")}
