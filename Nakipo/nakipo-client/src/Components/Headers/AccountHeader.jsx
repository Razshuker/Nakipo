        ...
        <header>
            ...
            <div className="bottom-bar row row-cols-2">
                <div className="col wallet p-0">
                    ...
                    >
                        <img
                            src={(pathname !== "?wallet" || pathname !== "") ? s3PublicFilesUrl + "5_1_blue.png" : s3PublicFilesUrl + "5_1_off.png"}
                            height={15}
                ...
                <div className="col rating-table p-0">
                    ...
                    >
                        <img
                            src={pathname !== "?rating" ? s3PublicFilesUrl + "5_2_blue.png" : s3PublicFilesUrl + "5_2_off.png"}
                            height={15}
                            className="col-auto p-0"
                            alt="rating"
                        />
                ...
                <div className="col challange p-0">
                    ...
                    >
                        <img
                            src={pathname !== "?challange" ? s3PublicFilesUrl+ "5_3_blue.png" : s3PublicFilesUrl+ "5_3_off.png"}
                            height={15}
                            className="col-auto p-0"
                            alt="challange"
                        />
                ...
                <div className="col feedo p-0">
                    ...
                    >
                        <img
                            src={pathname !== "?feedo" ? s3PublicFilesUrl+ "5_4_blue.png" : s3PublicFilesUrl + "5_4_off.png"}
                            height={15}
                            className="col-auto p-0"
                            alt="feedo"
                        />
